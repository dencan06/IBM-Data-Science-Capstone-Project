...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload_slider', min=0, max=10000, step=1000, value=[min_payload, max_payload], 
                                    ...
                                    3000:'3000', 4000: '4000', 5000: '5000', 6000: '6000', 7000: '7000', 8000: '8000',
...
def get_pie_chart(site_dropdown):
    ...
    if site_dropdown == 'ALL':
        ...
        fig = px.pie(filtered_df.loc[filtered_df['Launch Site'] == site_dropdown].groupby(['Launch Site', 'class']).size().reset_index(name='class count'), 
        values='class', names='Launch Site', title='Success Launches')
        return fig
